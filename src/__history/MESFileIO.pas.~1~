...
function GetMesStringByID(id: Integer; MesFILE: MessageFile): String;
function GetMesIDByString(id: String; MesFILE: MessageFile): Integer;
function ParseMES(filename: String): MessageFile;
function ParseMESFromModuleDAT(filename: String): MessageFile;
procedure AddMesEntry(id: Integer; messagestr: String; var mes: MessageFile);
procedure DeleteMesEntry(index: Integer; var mes: MessageFile);
procedure SaveMesFile(filename: String; mes: MessageFile);
function GetMesIDByStringLowerCase(id: String; MesFILE: MessageFile): Integer;
...
function ParseMESFromDAT(filename: String; var thehandle: file; datfile: String; dathandle: datfileheader): MessageFile;
...
begin
  ...
  begin
    ...
    Result.msgfilename := filename;
    splashmessage('Loaded mes file '+extractfilename(filename));
