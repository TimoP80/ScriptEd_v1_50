...
procedure ScriptLineAdd(str: PChar); stdcall; external 'ScriptEd.exe';
procedure GetScript(var scrptr: PScriptFile); stdcall; external 'ScriptEd.exe';
procedure GetModuleDir(var Data: PChar); stdcall; external 'ScriptEd.exe';
procedure DebugMessage(Data: PChar); stdcall; external 'ScriptEd.exe';
...
procedure AddVoiceComboItem (str: pchar); stdcall external 'ScriptEd.exe';
