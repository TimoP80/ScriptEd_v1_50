...
ScriptEd 1.50 - script editor for Arcanum modules
...
const
  ...
  Interface_Version = '1.50';



// Script file structures
...
procedure GetDialogue(var dlgptr: PDialogueFile); stdcall; external 'ScriptEd.exe';
procedure ScriptLineAdd(str: PansiChar); stdcall; external 'ScriptEd.exe';
procedure GetScript(var scrptr: PScriptFile); stdcall; external 'ScriptEd.exe';
procedure GetModuleDir(var Data: PansiChar); stdcall; external 'ScriptEd.exe';
procedure DebugMessage(Data: PAnsiChar); stdcall; external 'ScriptEd.exe';
procedure EditorFindLine(linenum: Integer); stdcall; external 'ScriptEd.exe';
procedure ClearVoiceComboItems; stdcall; external 'ScriptEd.exe';
procedure AddVoiceComboItem (str: pansichar); stdcall; external 'ScriptEd.exe';
