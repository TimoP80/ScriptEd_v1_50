...
type
  ...
  IXMLCompressionSettingsType = interface(IXMLNodeCollection)
    ...
    property SplitGroup[Index: Integer]: IXMLSplitGroupType
      read Get_SplitGroup; default;
  end;
  ...
  TXMLCompressionSettingsType = class(TXMLNodeCollection,
    IXMLCompressionSettingsType)
  protected
    { IXMLCompressionSettingsType }
    function Get_SplitGroup(Index: Integer): IXMLSplitGroupType;
...
function LoadCompressionSettings(const FileName: WideString)
  : IXMLCompressionSettingsType;
...
function GetCompressionSettings(Doc: IXMLDocument): IXMLCompressionSettingsType;
begin
  Result := Doc.GetDocBinding('CompressionSettings',
    TXMLCompressionSettingsType, TargetNamespace)
    as IXMLCompressionSettingsType;
end;

function LoadCompressionSettings(const FileName: WideString)
  : IXMLCompressionSettingsType;
begin
  Result := LoadXMLDocument(FileName).GetDocBinding('CompressionSettings',
    TXMLCompressionSettingsType, TargetNamespace)
    as IXMLCompressionSettingsType;
end;
...
function NewCompressionSettings: IXMLCompressionSettingsType;
begin
  Result := NewXMLDocument.GetDocBinding('CompressionSettings',
    TXMLCompressionSettingsType, TargetNamespace)
    as IXMLCompressionSettingsType;
end;
...
function TXMLCompressionSettingsType.Get_SplitGroup(Index: Integer)
  : IXMLSplitGroupType;
begin
...
function TXMLCompressionSettingsType.Insert(const Index: Integer)
  : IXMLSplitGroupType;
begin
...
function TXMLFoldersType.Insert(const Index: Integer; const Folder: WideString)
  : IXMLNode;
begin
