...
type
  TForm5 = class(TForm)
    ...
    procedure JvHTLabel1MouseMove(Sender: TObject; Shift: TShiftState;
      X, Y: Integer);
...
begin
  ...
  Form5.JvHTListBox1.Items.Add('<b>Display name:</b> ' + dllplugins[ind]
    .displayname);
  Form5.JvHTListBox1.Items.Add('<b>Created on:</b> ' +
    datetimetostr(dllplugins[ind].creationdate));
  Form5.JvHTListBox1.Items.Add('<b>Compiled on:</b> ' +
    datetimetostr(dllplugins[ind].builddate));
  Form5.JvHTListBox1.Items.Add('<b>Description:</b> ' +
    wraptext(dllplugins[ind].longdesc, '<br>', [',', ' '], 48));
  Form5.JvHTListBox1.Items.Add('<b>Interface Version:</b> ' + dllplugins[ind]
    .interfaceversion);
  Form5.JvHTListBox1.Items.Add
    ('<b>Exported functions: </b> <a href="DoLink_ShowExports(''' +
    dllplugins[ind].filename + ''')">Show</a> [' +
    IntToStr(plugin_info.ExportList.Count) + ' total]');
...
procedure TForm5.JvHTLabel1MouseMove(Sender: TObject; Shift: TShiftState;
  X, Y: Integer);
begin
