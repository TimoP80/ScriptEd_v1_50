...
uses
  ...
  dlgparser, SynCompletionProposal, SynAutoCorrect, dwsStringResult,
  JvComponentBase, JvMRUManager, JvAppStorage, JvFormPlacement,
  JvAppIniStorage, ToolWin, ImgList, AdvSmoothSplashScreen;
...
begin
  ...
  consoledebug('returned module dir as ' + ansistring(Data)+' modulefolder is '+modulefolder);
end;
...
begin
  messagedlg('Not implemented yet!' + #13 + #10 + '' + #13 + #10 +
    'A proper script line wizard will be' + #13 + #10 +
    'coming up in 1.50-stable!', mtInformation, [mbOK], 0);
end;
...
procedure TMainForm.dws2Unit1VariablesEditorYPositionReadVar
  (var Value: variant);
begin
