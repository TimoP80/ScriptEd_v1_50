...
uses System.SysUtils {$IFNDEF WIN32}, Str16 {$ENDIF};
type
{$IFNDEF RX_D4}
...
uses Winapi.Windows {$IFDEF WIN32} {$ELSE} WinTypes, WinProcs {$ENDIF};
...
begin
  ...
  begin
    ...
    begin
      ...
      else if (AnsiCompareStr(S, Switch) = 0) then
      begin
        Result := True;
        Exit;
      end;
