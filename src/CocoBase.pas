...
type
  ...
  TStatusUpdateProc = procedure(Sender : TObject; Status: AnsiString;
...
function PadL(S: AnsiString; ch : char; L : integer): AnsiString;
...
{ Edit by T. Pitkänen }
{ removed string capping to 255 chars}

  if Symbol.Len > 2048 then
    Symbol.Len := 2048;
