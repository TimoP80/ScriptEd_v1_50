...
function TMESParser.ErrorStr(const ErrorCode: Integer; const Data: String): String;
begin
  case ErrorCode of
...
function TMESParser.GetVersion: String;
var
...
function TMESParser.GetVersionComment: String;
begin
  Result := 'Arcanum MES Parser';
end;

function TMESParser.GetGrammarAuthor: String;
begin
  Result := 'T. Pitkänen';
end;

function TMESParser.GetGrammarCopyright: String;
begin
  Result := '(c) 2008 T. Pitkänen';
end;

procedure TMESParser.SetVersion(const Value: String);
begin
