object MainForm: TMainForm
  ...
  object dws2StringsUnit1: Tdws2StringsUnit
    Script = DelphiWebScriptII1
    Left = 664
    Top = 16
  end
  ...
  object AdvSmoothSplashScreen1: TAdvSmoothSplashScreen
    Version = '1.1.1.0'
    BasicProgramInfo.ProgramName.Text = 'ScriptEd'
    ...
    BasicProgramInfo.ProgramName.Location = ilTopCenter
    BasicProgramInfo.ProgramVersion.Text = 'version 1.50.4'
    ...
    Items = <>
    ListItems = <>
    ListItemsSettings.Rect.Top = 80
    ListItemsSettings.Rect.Height = 280
