...
begin
 ...
 MainForm.AdvSmoothSplashScreen1.Refresh;
  ...
  begin
    ...
    begin
     consoledebug('Initializing SAPI5 plugin - "'+dllplugins[u].displayname+'"');
  ...
  begin
    ...
    begin
      ...
      begin
      ConsoleDebug(TForm(Application.Components[t]).Name+' ('+TForm(Application.Components[t]).Caption+') is not centered to Main Form!');
