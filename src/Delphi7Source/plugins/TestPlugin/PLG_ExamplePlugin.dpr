library PLG_ExamplePlugin;

{ 

ScriptEd plugin 

Plugin Name: ScriptEd Plugin Example 
Author: T. Pitkänen

Description:

This is an example plugin for ScriptEd
...
begin
ScriptLineAdd('Hello world from the plugin!');
end;
