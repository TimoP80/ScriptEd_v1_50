...
type
  ...
  TGenerateSpeechProc = procedure(text_male, text_female: PAnsiChar;
    voicename: PAnsiChar; outputpath: PAnsiChar; linenum: integer); stdcall;
...
procedure ExecuteSpeechGenerator(filename: ansistring; text_male: ansistring;
  text_female: ansistring; voicename: ansistring; outputpath: ansistring; linenum: integer);
...
begin
  ...
  begin
    ...
    begin
      if text_female = '' then
        GenSpeechProc(PansiChar(text_male), nil, PansiChar(voicename),
          PansiChar(outputpath), linenum)
      else

        GenSpeechProc(PansiChar(text_male), PansiChar(text_female), PansiChar(voicename),
          PansiChar(outputpath), linenum);
    end;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          SplashMessage(DLLplugins[plugincnt].displayname);
